...
import java.sql.*;
import javax.swing.*;
public class NAPform extends javax.swing.JFrame {
    Connection con=null;
    ResultSet rs=null;
...
//      this.setUndecorated(true);
    ...
    private void initComponents() {
        ...
        btnSave.setBounds(711, 367, 50, 50);
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/add menu.jpg"))); // NOI18N
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
      ...
      String nic= txtnic.getText();
        ...
        try {
             String sql= "INSERT INTO nap (n_id,f_name,l_name,full_name,age,dob,gender,tp,address,marage,ac_no,bank,post,nic) VALUES ('"+id+"','"+fname+"','"+lname+"','"+fullname+"','"+age+"','"+dob+"','"+gender+"','"+tp+"','"+address+"','"+marage+"','"+acno+"','"+bank+"','"+post+"','"+nic+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NAPform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

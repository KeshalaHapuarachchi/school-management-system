...
import java.sql.*;
import javax.swing.*;
public class upadateteacher extends javax.swing.JFrame {
    Connection con=null;
    ResultSet rs=null;
    PreparedStatement pst=null;

    public upadateteacher() {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(30, 120, 34, 17);

        txttid.setColumns(10);
        getContentPane().add(txttid);
        txttid.setBounds(190, 120, 203, 20);
        ...
        jLabel4.setBounds(30, 180, 67, 17);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel5.setText("Full Name");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(30, 210, 63, 17);

        jLabel6.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel6.setText("Age");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(30, 240, 25, 17);

        jLabel7.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel7.setText("DOB");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(30, 270, 30, 17);

        jLabel8.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel8.setText("Gender");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(30, 310, 48, 17);

        txtfname.setColumns(20);
        getContentPane().add(txtfname);
        txtfname.setBounds(190, 150, 203, 20);

        txtlname.setColumns(20);
        getContentPane().add(txtlname);
        txtlname.setBounds(190, 180, 203, 20);

        txtfullname.setColumns(50);
        getContentPane().add(txtfullname);
        txtfullname.setBounds(190, 210, 300, 20);

        txtage.setColumns(3);
        getContentPane().add(txtage);
        txtage.setBounds(190, 240, 102, 20);

        txtdob.setColumns(12);
        getContentPane().add(txtdob);
        txtdob.setBounds(190, 270, 102, 20);
        ...
        cmbmarrage.setBounds(900, 140, 70, 20);
        ...
        btnUpdate.setBounds(720, 340, 50, 50);
        ...
        jScrollPane1.setBounds(10, 580, 1340, 92);

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/teachers menu.jpg"))); // NOI18N
        getContentPane().add(jLabel16);
        jLabel16.setBounds(40, 130, 400, 400);

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/update menu.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(upadateteacher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new upadateteacher().setVisible(true);
            }
        });
    }
